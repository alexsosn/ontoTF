...
- Setuptools supports SPDX expression plus `project.license-files` from v77; its migration guide recommends `setuptools>=77` and removing the old classifier. https://setuptools.pypa.io/en/stable/userguide/license_migration.html
